														...
														<div class="row">
															<div class="col-md-3 ">
																<h5 class="my-0"><span class="text-muted" style="color: #000000">Pedido:</span>
																	<a style="color: #000000" href="pedido.php?id=<?php echo $read_pedido_view['idApp_Pagamento'];?>"><?php echo $read_pedido_view['idApp_Pagamento'];?></a>
																</h5>
															</div>	
															<div class="col-md-3 ">
													...
													<?php } elseif($read_pedido_view['CombinadoFrete'] == 'S' && $read_pedido_view['AprovadoOrca'] == 'N'){?>
														<?php if(!(($read_pedido_view['TipoFrete'] == '1' || $read_pedido_view['TipoFrete'] == '3') && $read_pedido_view['AVAP'] == 'O')){?>
															<div class="row">
																...
																<div class="col-md-3 ">
																	<a href="aprovar_pedido.php?id=<?php echo $read_pedido_view['idApp_Pagamento'];?>">
																		<img src="../<?php echo $sistema ?>/arquivos/imagens/aprovado.png" class="img-responsive img-link" width='100'><h3>Confirmar</h3>
																	</a>
																</div>
																<div class="col-md-3 ">
																	<a href="cancelar_pedido.php?id=<?php echo $read_pedido_view['idApp_Pagamento'];?>">
																		...
																		<?php if($read_pedido_view['AVAP'] == 'O'){ ?>
																			<?php if($read_pedido_view['status'] == '0'){ ?>
																				<?php if($read_pedido_view['CombinadoFrete'] == 'S'){ ?>
																					<a href="pagar.php?id=<?php echo $read_pedido_view['idApp_Pagamento'];?>">Pagar OnLine</a>
																					<?php } else{ ?>
